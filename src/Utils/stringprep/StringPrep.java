 ...
 *
 * All rights reserved. Licensed under the Apache License, Version 2.0 (the "License"); you may not use this file except in compliance with
...
public class StringPrep {
     ...
     */
    static final CharClass SASL_PROHIBITED = CharClass.fromClasses(C12, C21, C22, C3, C4, C5, C6, C7, C8, C9);
    ...
    static abstract public class StringPrepError extends Exception {
        ...
        private static final long serialVersionUID = -7415296318036511431L;
    ...
    static public class StringPrepProhibitedCharacter extends StringPrepError {
        ...
        private static final long serialVersionUID = -3584062286413857537L;
    ...
    static public class StringPrepUnassignedCodepoint extends StringPrepProhibitedCharacter {
        ...
        private static final long serialVersionUID = -6178988351183716436L;
    ...
    static public class StringPrepRTLError extends StringPrepError {
        ...
        private static final long serialVersionUID = 6037222137017409084L;
    ...
    static public class StringPrepRTLErrorBothRALandL extends StringPrepRTLError {
        ...
        private static final long serialVersionUID = 8699734260843005804L;
    };

    static public class StringPrepRTLErrorRALWithoutPrefix extends StringPrepRTLError {

        private static final long serialVersionUID = 477852162119660722L;
    };

    static public class StringPrepRTLErrorRALWithoutSuffix extends StringPrepRTLError {

        private static final long serialVersionUID = -5004170539489939371L;
    };

    /**
     * Replace each character of {@code s} which is in the {@link CharClass} mapFrom with the string {@code mapTo}.
     */
    ...
    /**
     * Return the first character index in s which is in {@link CharClass}, or -1 if no character is in the class.
     */
    ...
    /**
     * Perform RTL verification according to rfc3454 section 6. On failure, throw a subclass of {@link StringPrepRTLError}.
     *
     * @param s
     *
     * @throws Utils.stringprep.StringPrep.StringPrepRTLError
     */
     ...
     * @return
     *
     * @throws Utils.stringprep.StringPrep.StringPrepError
     */
    ...
    static public String prepAsQueryString(String s) throws StringPrepError {
        ...
        // 3) Prohibit
        int idx = containsCharacterInClass(s, SASL_PROHIBITED);
        if (idx != -1) {
