 ...
 */
package Utils.stringprep;

import java.lang.reflect.InvocationTargetException;
import java.lang.reflect.Method;

/**
 * Dynamically-loaded interface for java.text.Normalizer(NFKC); it's missing in non-bleeding-edge versions of Android and we can get by
 * without it.
 */
class Normalizer {
    ...
    /**
     * Equivalent to {@link java.text.Normalizer#normalize}(seq, Normalizer.Form.NFKC). If Normalizer is unavailable, returns the sequence
     * unchanged.
     */
    ...
    public static class XMPPException extends Exception {

        private static final long serialVersionUID = 4778073784820131808L;
